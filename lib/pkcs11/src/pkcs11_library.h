...
public:
    ...
    CK_RV openSession(CK_SLOT_ID slotID, CK_FLAGS flags,
    ...
    CK_RV login(CK_SESSION_HANDLE hSession, CK_USER_TYPE userType,
...
private:
    ...
    bool matchesTemplate(const PKCS11Object& obj,
