...
inline const std::vector<uint8_t> MEDICAL_ATR_1 = {0x3B, 0xF4, 0x13, 0x00, 0x00, 0x81, 0x31,
                                                   0xFE, 0x45, 0x52, 0x46, 0x5A, 0x4F, 0xED};
inline const std::vector<uint8_t> MEDICAL_ATR_2 = {0x3B, 0x9E, 0x97, 0x80, 0x31, 0xFE, 0x45, 0x53, 0x43, 0x45, 0x20,
                                                   0x38, 0x2E, 0x30, 0x2D, 0x43, 0x31, 0x56, 0x30, 0x0D, 0x0A, 0x6E};

// AID — SERVSZK Serbian health insurance application
inline const std::vector<uint8_t> AID_SERVSZK = {0xF3, 0x81, 0x00, 0x00, 0x02, 0x53, 0x45,
