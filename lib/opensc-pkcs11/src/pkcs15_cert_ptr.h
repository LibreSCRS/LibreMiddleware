...
/// @c std::bad_alloc.
///
/// Lives under the neutral @c LibreSCRS::OpenSc namespace because two
/// sibling OpenSC consumers (@c opensc-plugin and @c opensc-pkcs11) now
/// reuse it; the previous nested @c Plugin namespace was specific to
/// the original single consumer.
