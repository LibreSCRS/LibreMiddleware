...
// Sequence 1
inline const std::vector<uint8_t> SEQ1_CMD1 = {
    0xA0, 0x00, 0x00, 0x01, 0x51, 0x00, 0x00
};
inline const std::vector<uint8_t> SEQ1_CMD2 = {
    0xA0, 0x00, 0x00, 0x00, 0x77, 0x01, 0x08, 0x00,
    0x07, 0x00, 0x00, 0xFE, 0x00, 0x00, 0x01, 0x00
};
inline const std::vector<uint8_t> SEQ1_CMD3 = {
    0xA0, 0x00, 0x00, 0x00, 0x77, 0x01, 0x08, 0x00,
    0x07, 0x00, 0x00, 0xFE, 0x00, 0x00, 0xAD, 0xF2
};

// Sequence 2
inline const std::vector<uint8_t> SEQ2_CMD1 = {
    0xA0, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00
};
inline const std::vector<uint8_t> SEQ2_CMD2 = {
    0xF3, 0x81, 0x00, 0x00, 0x02, 0x53, 0x45, 0x52,
    0x56, 0x4C, 0x04, 0x02, 0x01
};
// SEQ2_CMD3 is the same as SEQ1_CMD3

// Sequence 3
inline const std::vector<uint8_t> SEQ3_CMD1 = {
    0xA0, 0x00, 0x00, 0x00, 0x18, 0x43, 0x4D, 0x00
};
inline const std::vector<uint8_t> SEQ3_CMD2 = {
    0xA0, 0x00, 0x00, 0x00, 0x18, 0x34, 0x14, 0x01,
    0x00, 0x65, 0x56, 0x4C, 0x2D, 0x30, 0x30, 0x31
};
inline const std::vector<uint8_t> SEQ3_CMD3 = {
    0xA0, 0x00, 0x00, 0x00, 0x18, 0x65, 0x56, 0x4C,
    0x2D, 0x30, 0x30, 0x31
};
