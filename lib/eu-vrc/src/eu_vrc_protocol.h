...
inline const std::vector<uint8_t> EU_VRC_AID = {0xA0, 0x00, 0x00, 0x04, 0x56, 0x45, 0x56, 0x52, 0x2D, 0x30, 0x31};
...
inline constexpr FileFidEntry STANDARD_FILES[] = {
    {0xD0, 0x01, "EF.Registration_A", true}, {0xD0, 0x11, "EF.Registration_B", true},
    {0xE0, 0x01, "EF.Signature_A", false},   {0xE0, 0x11, "EF.Signature_B", false},
    {0xC0, 0x01, "EF.C.IA_A.DS", false},     {0xC0, 0x11, "EF.C.IA_B.DS", false},
};
