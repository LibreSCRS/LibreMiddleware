...
// =============================================================================
// Gemalto USB Shell Token V2 — AODF (EF 4408)
// SafeSign PKI applet v3.0.0.6 (JCOP21 V2.3.1)
// Notable: maxLength ABSENT (OPTIONAL), padChar present, lastPinChange present
// =============================================================================
constexpr std::array<uint8_t, 191> GEMALTO_AODF = {
    ,
